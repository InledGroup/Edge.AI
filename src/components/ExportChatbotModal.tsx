...
export function ExportChatbotModal() {
  ...
  const [chatbotDescription, setChatbotDescription] = useState('Asistente virtual basado en documentos');
  ...
  const handleGeneratePreview = async () => {
    setStep('exporting');
    setExportProgress(0);
    setExportStatus('Generando vista previa...');
  ...
  const handleExport = () => {
    ...
    setStep('exporting');
    setExportStatus('Preparando descarga...');
      ...
      <Card class="w-full max-w-2xl bg-[var(--color-bg)] border border-[var(--color-border)] rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div class="p-4 border-b border-[var(--color-border)] bg-[var(--color-bg-secondary)] flex items-center justify-between">
          <div class="flex items-center gap-2">
            ...
            <h3 class="font-bold text-sm uppercase tracking-widest">Exportar Chatbot</h3>
          </div>
          <button
            onClick={handleClose}
        ...
        <div class="p-6 overflow-y-auto custom-scrollbar flex-1">
            ...
            <div class="space-y-6">
              ...
              <div class="p-4 bg-blue-900/20 border border-blue-800 rounded-lg flex items-start gap-3">
                ...
                <div class="text-sm text-blue-200">
                  <p class="font-semibold mb-1">¿Qué se exportará?</p>
                  <ul class="list-disc list-inside space-y-1 text-blue-300">
                    <li>Tus {readyDocuments.length} documentos procesados</li>
                    <li>Embeddings pre-calculados (sin procesamiento en tiempo real)</li>
                    <li>Modelo {selectedModel.split('-').slice(0, 3).join(' ')}</li>
                    <li>Interfaz de chatbot web</li>
                  </ul>
                </div>
              </div>
              ...
              {/* Chatbot Info */}
              <div class="space-y-4">
                <h4 class="text-sm font-bold text-white uppercase tracking-wider">Información del Chatbot</h4>
              ...
              <div class="space-y-4">
                ...
                <select
                  ...
                  class="w-full px-4 py-2.5 bg-[var(--color-bg-tertiary)] border border-[var(--color-border)] rounded-lg text-white focus:outline-none focus:border-[var(--color-primary)] transition-colors"
                >
                  <option value="SmolLM2-135M-Instruct-q0f16-MLC">SmolLM2 135M (Más rápido)</option>
                  <option value="SmolLM2-360M-Instruct-q4f16_1-MLC">SmolLM2 360M (Móvil)</option>
                  <option value="Qwen2.5-0.5B-Instruct-q4f16_1-MLC">Qwen 2.5 0.5B (Recomendado)</option>
                  ...
                  <option value="Phi-3.5-mini-instruct-q4f16_1-MLC">Phi-3.5 Mini (Premium)</option>
                </select>
              </div>
              ...
              <div class="space-y-4">
                ...
                <div class="space-y-3">
                  <div class="flex items-center justify-between">
                    <label class="text-sm text-gray-300">Top-K (Fragmentos)</label>
                ...
                <div class="space-y-3">
                  <div class="flex items-center justify-between">
                    <label class="text-sm text-gray-300">Temperatura</label>
                ...
                <div class="space-y-3">
                  <div class="flex items-center justify-between">
                    <label class="text-sm text-gray-300">Máx Tokens</label>
              ...
              <div class="p-4 bg-[var(--color-bg-secondary)] rounded-lg border border-[var(--color-border)]">
                <div class="flex items-center gap-2 mb-2">
                  ...
                  <span class="text-sm font-medium text-white">Documentos a exportar</span>
                </div>
          ...
          {step === 'preview' && previewHTML && (
            <div class="space-y-4">
              <div class="flex items-center gap-2 text-sm text-gray-400 mb-4">
                <Eye size={16} />
                <span>Vista previa del chatbot exportado</span>
              </div>
          ...
          {step === 'exporting' && (
            <div class="flex flex-col items-center justify-center py-12">
              ...
              <h3 class="text-lg font-bold text-white mb-2">Exportando Chatbot...</h3>
          ...
          <div class="p-4 border-t border-[var(--color-border)] bg-[var(--color-bg-secondary)] flex justify-between items-center gap-3">
            {step === 'preview' ? (
              ...
              <>
                ...
                >
                  <Eye size={16} />
                  {hasDocuments ? 'Generar Vista Previa' : 'Sube documentos primero'}
                </Button>
              </>
            )}
          </div>
